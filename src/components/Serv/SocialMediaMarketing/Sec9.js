      ...
      <div className="row justify-content-center">
        <div className="col-xl-12 col-lg-7">
          <div className="section-title-two text-center mb-40 tg-heading-subheading animation-style1">
            ...
            Featuring Our Web Development Management For Your Company!           </h2>
            <p>
      ...
      <div className="features-item-wrap-two">
        <div className="row justify-content-center">
          <div className="col-xl-2 col-lg-2 col-md-6 col-6">
            <div className="features-item-three">
              ...
              <div className="features-content-three">
                <h2 className="title">Strategic & Planning</h2>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-2 col-lg-2 col-md-6 col-6">
            <div className="features-item-three">
              ...
              <div className="features-content-three">
                <h2 className="title">Flexible,Innovative Solution</h2>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-2 col-lg-2 col-md-6 col-6">
            <div className="features-item-three">
              ...
              <div className="features-content-three">
                <h2 className="title">Device & SEO Friendly</h2>
          ...
          <div className="col-xl-2 col-lg-2 col-md-6 col-6">
            <div className="features-item-three">
              ...
              <div className="features-content-three">
                <h2 className="title">Excellent Support</h2>
        ...
        <div className="col-xl-2 col-lg-2 col-md-6 col-6">
            <div className="features-item-three">
              ...
              <div className="features-content-three">
                <h2 className="title">Excellence Customer Experiance
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-2 col-lg-2 col-md-6 col-6" >
            <div className="features-item-three">
              ...
              <div className="features-content-three">
                <h2 className="title">Fast & Secure</h2>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-2 col-lg-2 col-md-6 col-6">
            <div className="features-item-three">
              ...
              <div className="features-content-three">
                <h2 className="title">Delivery & Launch</h2>
