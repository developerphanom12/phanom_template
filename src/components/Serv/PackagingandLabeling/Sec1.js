          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="banner-content-two">
                ...
                YOUR COVER IS HERE! Remarkably awesome Need packaging & labelling services for your product?

                </h2>
                <p data-aos="fade-up" data-aos-delay="500">
                Phanom Professionals create your Brand to existence in the Market.


                </p>
                <p data-aos="fade-up" data-aos-delay="500">
                Before Phanom: The empty brand come to us to become


                </p>
                <p data-aos="fade-up" data-aos-delay="500">
                After Phanom: Everything that your consumer needs to
know and take home.
